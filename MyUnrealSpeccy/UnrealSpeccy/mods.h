...
#define VERS_STRING  "0.38.0"   // version for monitor (exact 6 chars)
#define VERS_STRING_ VERS_STRING //##".alpha"  // version for startup string (any length)
#define VER_HL 0x0026           // major version
...
#if defined(_M_IX86_FP) && (_M_IX86_FP >= 2) // compiled with option /arch:SSE2
 #define MOD_SSE2
#else
 #undef MOD_SSE2
#endif
